...
- docs: fix Table of Contents Links [`#842`](https://github.com/OpenZWave/Zwave2Mqtt/pull/842)
- feat: persistent settings for node table filter, sorting, show hidden nodes [`#831`](https://github.com/OpenZWave/Zwave2Mqtt/pull/831)
- fix: incorrect drying HVAC mode to dry [`#833`](https://github.com/OpenZWave/Zwave2Mqtt/pull/833)
- fix: incorrect drying HVAC mode to dry [`#833`](https://github.com/OpenZWave/Zwave2Mqtt/pull/833)
- fix: upgrade @babel/polyfill from 7.11.5 to 7.12.1 [`#818`](https://github.com/OpenZWave/Zwave2Mqtt/pull/818)
- fix: upgrade serialport from 9.0.1 to 9.0.2 [`#819`](https://github.com/OpenZWave/Zwave2Mqtt/pull/819)
- feat: node table filter [`#823`](https://github.com/OpenZWave/Zwave2Mqtt/pull/823)
- chore: bump chrisns/openzwave to 1.6.1545 [`#825`](https://github.com/OpenZWave/Zwave2Mqtt/pull/825)
- feat: persistent settings for node table filter, sorting, show hidden nodes (#831) [`#490`](https://github.com/OpenZWave/Zwave2Mqtt/issues/490)
- feat: Update last active on node messages [`#490`](https://github.com/OpenZWave/Zwave2Mqtt/issues/490)
- refactor: Introduce reusable settings compoment [`c101f0e`](https://github.com/OpenZWave/Zwave2Mqtt/commit/c101f0ec90328635496c93bb58e68a1a389242da)
- chore(deps): bump debug from 4.1.1 to 4.2.0 [`932a98a`](https://github.com/OpenZWave/Zwave2Mqtt/commit/932a98ab0a9aedfa2e21c096b58b9b13996f36db)
...
- fix: File locations and module style [`5ab71e5`](https://github.com/OpenZWave/Zwave2Mqtt/commit/5ab71e5a837662e3742ff89999c226d3a144992b)
- chore(deps-dev): bump ora from 5.0.0 to 5.1.0 [`a44e6a1`](https://github.com/OpenZWave/Zwave2Mqtt/commit/a44e6a1d7da3d6930ec891afab38e8bc7eef7a20)
- fix: Remove triggerStatusUpdate [`a378264`](https://github.com/OpenZWave/Zwave2Mqtt/commit/a378264c3e2cb0051da2adf593a8ec8106a551e3)
- fix: eslint errors [`638e292`](https://github.com/OpenZWave/Zwave2Mqtt/commit/638e29228173c0d4421946bb7ea6e3176ebc9448)
- fix: Check failures [`105d62a`](https://github.com/OpenZWave/Zwave2Mqtt/commit/105d62ae7f4f029f0beac69b7f9de1d788a66c8d)
- refactor: Simplify changes [`4bb2fe3`](https://github.com/OpenZWave/Zwave2Mqtt/commit/4bb2fe3bcfde49cf85b562bf10145ec36cdda9d5)
- fix: Use const for filtersStr [`7fccb37`](https://github.com/OpenZWave/Zwave2Mqtt/commit/7fccb37bcebdcf5951e576646c11ea167260f917)
...
- Release 4.0.6 [`a6664ce`](https://github.com/OpenZWave/Zwave2Mqtt/commit/a6664ce2310b756f3b0cfdca08d6e56095e14ff8)
